                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Informe seu e-mail e senha para cadastrar-se!
                        </p>
                    </div>
                    <div>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Já possui uma conta?
                                <a href="/signin" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Entrar</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="{{ asset('images/logo/logo-adapta-consultas.webp') }}" alt="Logo" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Template de painel administrativo Tailwind CSS gratuito e de código aberto
                        </p>
                    </div>
                </div>
            </div>
