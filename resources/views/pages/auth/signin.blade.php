                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="{{ asset('images/logo/logo-adapta-consultas.webp') }}" alt="Logo" class="h-10 w-auto" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Soluções completas para análise de crédito, negativação e proteção empresarial
                        </p>
                    </div>
                </div>
            </div>
