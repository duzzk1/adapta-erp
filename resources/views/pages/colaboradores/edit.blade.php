...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Editar Colaborador</h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Atualize os dados do colaborador.</p>
        </div>
    ...
    <form method="POST" action="{{ route('colaboradores.update', $collaborator) }}" class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        @csrf
        @method('PUT')
