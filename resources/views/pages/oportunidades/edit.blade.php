...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Editar Oportunidade</h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Atualize os dados da negociação.</p>
        </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <form method="POST" action="{{ route('oportunidades.update', $oportunidade) }}" class="space-y-6">
            @csrf
            @method('PUT')
            @include('pages.oportunidades._form', ['oportunidade' => $oportunidade])
